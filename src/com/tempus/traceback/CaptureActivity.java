...
import com.tempus.camera.CameraManager;
import com.tempus.decode.DecodeThread;
import com.tempus.traceback.ActionbarView.OnActionBtnClickListener;
import com.tempus.zxing.utils.BeepManager;
import com.tempus.zxing.utils.CaptureActivityHandler;
import com.tempus.zxing.utils.InactivityTimer;
 ...
 * @author Sean Owen
 */
public final class CaptureActivity extends Activity implements SurfaceHolder.Callback,OnActionBtnClickListener {
	...
	public void StartgetIntent(){
		...
		intentType = intent.getIntExtra(intentTypestr, 0);
	}
...
//		finish();
	    if(intentType == 1){
	    	Intent aintent = new Intent(CaptureActivity.this, Write2Nfc.class);
	    	/* 将数据打包到aintent Bundle 的过程略 */
	    	aintent.putExtra(requertdata, rawResult.getText());
